...
//    }
    ...
    @Bean
    fun reactiveAuthenticationManager(userDetailsServiceImpl: UserDetailsServiceImpl): ReactiveAuthenticationManager =
        UserDetailsRepositoryReactiveAuthenticationManager(userDetailsServiceImpl).apply {
