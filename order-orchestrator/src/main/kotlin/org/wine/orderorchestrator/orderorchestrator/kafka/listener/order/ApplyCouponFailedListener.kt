...
import org.wine.orderorchestrator.orderorchestrator.order.transcation.event.ApplyCouponFailedEvent
...
class ApplyCouponFailedListener(
    ...
    override fun onMessage(data: ConsumerRecord<String, String>, acknowledgment: Acknowledgment?) {
        val (key, event) = data.key() to objectMapper.readValue(data.value(), ApplyCouponFailedEvent::class.java)
